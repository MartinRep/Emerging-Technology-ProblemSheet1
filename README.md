# Solutions for a Python fundalentals problem sheet.
Solutions are in files named by individual problem.

- You need to have Python installed on your machine. [Python download link](https://www.python.org/downloads/)

- How to run example
``python HelloWorld.py``

# Problem set: Python fundamentals
Learning Python was a part of emerging technologies module in 4th year of softtware development course in GMIT.
